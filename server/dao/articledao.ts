...
module.exports = class ArticleDao extends Dao {
  ...
  createOne(json, callback){
      const val = [json.title, json.summary, json.article_text, json.image, json.priority];
      super.query(
  ...
  updateOne(json, id, callback){
      const val = [json.title, json.summary, json.article_text, json.image, json.priority, id];
      super.query(
